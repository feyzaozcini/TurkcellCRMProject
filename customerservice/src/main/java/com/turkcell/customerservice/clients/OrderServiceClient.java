...
//@FeignClient(name = "orderservice", url = "http://localhost:8086", configuration = FeignConfiguration.class) //for local
@FeignClient(name = "order-service", url = "http://order-service:8086", configuration = FeignConfiguration.class)
